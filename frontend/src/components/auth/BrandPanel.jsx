...
export const BrandPanel = () => {
  ...
  return (
    <div className="relative w-full h-full flex flex-col justify-between p-8 sm:p-12 lg:p-14 bg-[#F8FAFC] border-r border-[#E2E8F0] text-[#17221B] select-none">
      ...
      <div className="my-auto py-8 space-y-6 max-w-md">
        <div className="space-y-3">
          <h1 className="text-2xl sm:text-3xl font-bold tracking-tight text-[#17221B] leading-snug">
            Connected care,<br />
