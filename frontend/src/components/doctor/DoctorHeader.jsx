...
export const DoctorHeader = ({ onMenuOpen, title, subtitle }) => {
  ...
  const subHeading = subtitle || "Here's your patient and workflow overview for today.";
      ...
      <div className="flex items-center gap-2 sm:gap-3 flex-shrink-0">
        ...
        <div className="relative">
          <button
            ...
            className={`relative flex h-9 w-9 items-center justify-center rounded-xl border transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-[#0F766E] ${
              notificationsOpen
              ...
              <div className="absolute right-0 mt-2 w-80 sm:w-96 rounded-2xl bg-white shadow-xl border border-[#E2E8F0] z-40 p-3 animate-in fade-in zoom-in-95 duration-150">
                <div className="flex items-center justify-between pb-2.5 mb-2 border-b border-[#E2E8F0] px-1">
                  <div className="flex items-center gap-2">
                    <span className="text-xs font-bold text-[#0F172A]">Doctor Notifications</span>
                    {unreadCount > 0 && (
        ...
        <div className="flex items-center gap-2.5 pl-1.5 border-l border-[#E2E8F0]">
          ...
          <div className="hidden sm:block leading-tight text-left">
            <div className="text-xs font-bold text-[#0F172A] flex items-center gap-1 truncate max-w-[140px]">
              {doctorName}
            </div>
