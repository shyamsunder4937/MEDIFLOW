    ...
    <div className="flex flex-col h-full bg-white border-r border-[#E2E8F0] select-none">
      ...
      <div className="flex items-center justify-between px-5 py-5 border-b border-[#E2E8F0]">
        <div className="flex items-center gap-2.5">
          <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-[#0F766E] text-white shadow-sm flex-shrink-0">
      ...
      <div className="px-3 pb-3">
        <div className="p-3 rounded-xl bg-slate-50 border border-[#E2E8F0] text-xs">
          ...
          <div className="font-semibold text-[#0F172A] text-xs">Suite 4B • OPD</div>
      ...
      <div className="px-3 py-3 border-t border-[#E2E8F0] space-y-0.5">
        ...
        <button
          ...
          className="w-full flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium text-[#DC2626] hover:bg-red-50 transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-red-400 text-left"
        >
