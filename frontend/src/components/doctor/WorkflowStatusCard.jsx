    ...
    <div className="bg-white rounded-xl border border-[#E2E8F0] p-4 sm:p-5 shadow-xs space-y-4">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 pb-3.5 border-b border-[#E2E8F0]">
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="text-xs font-bold text-[#17221B] bg-slate-100 px-2.5 py-1 rounded-lg">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 pt-1">
        <div className="p-2.5 rounded-lg bg-slate-50 border border-slate-100 text-xs">
          ...
          <span className="font-bold text-[#15803D] text-sm mt-0.5 block">
        ...
        <div className="p-2.5 rounded-lg bg-slate-50 border border-slate-100 text-xs">
          ...
          <span className="font-bold text-[#17221B] text-sm mt-0.5 block">
        ...
        <div className="p-2.5 rounded-lg bg-slate-50 border border-slate-100 text-xs">
          ...
          <span className="font-bold text-[#17221B] text-sm mt-0.5 block truncate">
