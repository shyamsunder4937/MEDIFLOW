      ...
      <div className="flex flex-col lg:flex-row items-stretch lg:items-center justify-between gap-3">
        ...
        <div className="relative flex-1 min-w-0">
          ...
          <input
            ...
            placeholder="Search by patient name, appointment ID (e.g. APT-1001), or doctor..."
        ...
        <div className="pt-2 border-t border-slate-100 flex flex-wrap items-center justify-between gap-2 text-xs text-[#64748B]">
          <div className="flex flex-wrap items-center gap-1.5">
            ...
            {doctorFilter !== 'ALL' && (
              <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-md bg-slate-100 text-[#0F172A] text-[11px] font-medium border border-slate-200">
                Doctor: {doctorFilter}
                <button type="button" onClick={() => onDoctorChange('ALL')} className="hover:text-red-500">
                  <X className="h-3 w-3" />
                </button>
              </span>
            )}
            ...
            {typeFilter !== 'ALL' && (
              <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-md bg-slate-100 text-[#0F172A] text-[11px] font-medium border border-slate-200">
                Type: {typeFilter}
                <button type="button" onClick={() => onTypeChange('ALL')} className="hover:text-red-500">
                  <X className="h-3 w-3" />
                </button>
              </span>
            )}
          ...
          <span className="text-[11px] font-medium text-[#64748B]">
            Showing <strong className="text-[#0F172A]">{totalResults}</strong> of {totalCount} appointments
          </span>
        </div>
      )}
    </div>
