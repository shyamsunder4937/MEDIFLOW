...
export const RescheduleModal = ({
  ...
  return (
    ...
    >
      ...
      >
        {/* Header */}
        <div className="flex items-center justify-between px-5 sm:px-6 py-4 bg-gradient-to-r from-slate-50 to-purple-50/40 border-b border-[#E2E8F0]">
          <div className="flex items-center gap-3">
            <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-purple-100 text-purple-700 shadow-xs">
            ...
            <div>
              ...
              <p className="text-xs text-[#64748B]">
                Updating slot for <strong className="text-[#0F172A]">{appointment.patientName}</strong> ({appointment.id})
              </p>
            </div>
          </div>
        ...
        <form onSubmit={handleSubmit} className="p-5 sm:p-6 space-y-4">
          <div className="p-3.5 rounded-xl bg-slate-50 border border-slate-100 text-xs text-[#64748B] space-y-1">
            <div className="font-semibold text-[#0F172A]">Current Schedule:</div>
            <div>
              Date: <span className="font-medium text-[#0F172A]">{appointment.formattedDate || appointment.date}</span> at <span className="font-medium text-[#0F172A]">{appointment.time}</span>
            </div>
            <div>
              Doctor: <span className="font-medium text-[#0F172A]">{appointment.doctor}</span> ({appointment.department})
            </div>
          </div>
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                required
                className="w-full rounded-xl border border-[#E2E8F0] bg-slate-50/60 px-3.5 py-2 text-xs sm:text-sm text-[#0F172A] focus:bg-white focus:outline-none focus:ring-2 focus:ring-purple-500/20"
              />
            </div>
          </div>
          ...
          <div>
            ...
            <select
              ...
              className="w-full rounded-xl border border-[#E2E8F0] bg-slate-50/60 px-3 py-2 text-xs sm:text-sm font-semibold text-[#0F172A] focus:bg-white focus:outline-none focus:ring-2 focus:ring-purple-500/20 cursor-pointer"
            >
          ...
          <div className="pt-4 border-t border-[#E2E8F0] flex items-center justify-end gap-3">
            ...
            <button
              ...
              className="inline-flex items-center gap-2 px-5 py-2 rounded-xl bg-purple-600 hover:bg-purple-700 text-white text-xs sm:text-sm font-bold shadow-xs active:scale-[0.98] transition-all cursor-pointer disabled:opacity-50"
            >
