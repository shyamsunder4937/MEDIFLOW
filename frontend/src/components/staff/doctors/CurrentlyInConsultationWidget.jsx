    ...
    <div className="bg-white rounded-xl border border-[#E2E8F0] p-4 sm:p-5 shadow-2xs space-y-3.5">
      <div className="flex items-center justify-between pb-2.5 border-b border-[#E2E8F0]">
        <div className="flex items-center gap-2">
          ...
          <div>
            <h3 className="text-sm font-bold text-[#17221B]">Currently in Consultation</h3>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
        {busyDoctors.length > 0 ? (
          busyDoctors.map((doc) => (
            <div
              key={doc.id}
              className="p-3.5 rounded-lg border border-blue-100 bg-blue-50/20 space-y-2.5 hover:border-blue-300 transition-colors"
            >
              <div className="flex items-start justify-between gap-2">
                <div>
                  <div className="font-bold text-xs sm:text-sm text-[#17221B] flex items-center gap-1.5">
                ...
                <div className="flex items-center gap-1 font-mono text-[11px] font-bold text-[#15803D] bg-white px-2 py-0.5 rounded-md border border-[#E2E8F0]">
              ...
              <div className="p-2 rounded-md bg-white border border-blue-100/80 text-xs space-y-1">
                <div className="flex items-center justify-between">
                  <span className="text-[#64748B] flex items-center gap-1 text-[11px]">
                    <User className="h-3 w-3 text-blue-600" /> Patient:
                  </span>
                  <span className="font-bold text-[#17221B] truncate max-w-[140px]">
              ...
              <button
                ...
                className="w-full inline-flex items-center justify-center gap-1.5 py-1.5 px-3 rounded-md bg-white hover:bg-blue-50 text-blue-700 text-xs font-semibold border border-blue-200 transition-colors cursor-pointer"
              >
