...
export const PharmacyFilters = ({
  ...
  return (
    <div className="bg-white rounded-2xl border border-[#E2E8F0] p-4 sm:p-5 space-y-4 shadow-xs">
      {/* ── Top Bar: Search + Quick Dropdowns ── */}
      <div className="flex flex-col md:flex-row gap-3">
        ...
        <div className="relative flex-1">
          ...
          <input
            ...
            placeholder="Search patient, prescription ID, or doctor..."
      ...
      <div className="flex flex-wrap items-center justify-between gap-2 pt-2 border-t border-slate-100 text-xs text-[#64748B]">
        <div className="flex items-center gap-1.5 font-medium">
          ...
          <span>
            ...
            <strong className="text-[#0F172A] font-bold">{totalCount}</strong> prescription orders
          </span>
        </div>
